...
import PublicMainLayout from "./components/layouts/PublicMainLayout.tsx";
...
export const router: RouteObject[] = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'events',
                async lazy() {
                    const EventsPage = await import('./components/pages/EventsPage');
                    return { Component: EventsPage.default };
                }
            },
            {
                path: 'events/:eventId',
                async lazy() {
                    const EventPage = await import('./components/pages/EventPage');
                    return { Component: EventPage.default };
                }
            },
            {
                path: 'about',
                async lazy() {
                    const AboutPage = await import('./components/pages/AboutPage');
            ...
            },
            {
                path: 'contact',
                async lazy() {
                    const ContactPage = await import('./components/pages/ContactPage');
