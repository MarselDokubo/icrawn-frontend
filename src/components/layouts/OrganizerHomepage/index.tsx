...
export const OrganizerHomepage = ({
    ...
    const getGoogleMapsUrl = (locationDetails: import("../../../types").VenueAddress | undefined) => {
    ...
    const backgroundColor = removeTransparency(themeSettings?.homepage_background_color || '#f5f5f5');
                                                    ...
                                                    <div className={classes.organizerMeta}>
                                                        {getShortLocationDisplay(organizer?.settings?.location_details) && (
                                                            <div className={classes.metaItem}>
                                                                ...
                                                                <a
                                                                    href={getGoogleMapsUrl(organizer.settings && organizer.settings.location_details)}
                                                                    target="_blank"
                                                                    rel="noopener noreferrer"
                                                                    className={classes.mapLink}
                                                                >
                                                                    <span>{getShortLocationDisplay(organizer.settings && organizer.settings.location_details)}</span>
                                                                    &nbsp;
